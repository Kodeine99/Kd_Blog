...
function Footer() {
  return (
    <>
      {/* footer */}
      <footer className="bg-gray-300 w-full py-6 px-4 mt-32 ">
        ...
        <div className="px-4 pt-3 pb-4 border-b -mx-4 border-gray-400">
          <div className="max-w-xl mx-auto">
            ...
            <form action="#sociallink" className="mt-2">
        ...
        <div className="items-center text-center my-4">
          ...
          {/* <p className="text-blue-500 text-center">All rights reserved</p> */}
          <p className="inline-flex text-blue-500 pt-6">
            Built with
            <svg
              fill="#e53e3e"
              viewBox="0 0 24 24"
